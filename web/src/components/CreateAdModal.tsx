...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        ...
        if (data.name == "" || data.yearsPlaying == "" || data.discord == "" || weekDays.length == 0 || data.hourStart == "" || data.hourEnd == "") {
            alert('Campos obrigatórios não informados. Favor verificar.');
            return;
        }
        ...
        try {
            ...
            alert(`Erro ao criar anúncio! Msg: ${error}`);
        }
    }
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-white">
                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <label className="mt-2 flex items-center gap-2 text-sm">
                        ...
                        >
                            <Checkbox.Indicator>
                                <Check className="w-4 h6 text-emerald-400" />
                            </Checkbox.Indicator>
                        </Checkbox.Root>
